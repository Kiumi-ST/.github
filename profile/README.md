...
>
> 🔥 **키오스크는 급속히 확대되어 어느덧 현대 생활 속 필수 요소로 자리 잡았습니다. 하지만 매장마다 전혀 다른 UI/UX를 제공해 많은 사용자가 혼란을 느끼고 있습니다.**
>
> ⚙️ 사용자가 다양한 업체의 **키오스크 인터페이스**를 사전에 **경험해 볼 수 있는 서비스를** 제공하고자 합니다.
>
> 📅 **개발기간: 2024.03 ~ 2024.10**
